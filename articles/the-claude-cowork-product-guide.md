...
## 开始使用 Claude Cowork / Getting started with Claude Cowork

<!-- bilingual:section -->

<!-- lang:zh -->

这篇文章介绍如何开始使用 Claude Cowork，包括哪些工作流、习惯和插件能把你的想法转化为打磨完成的交付物。

大多数 AI 工具本质上是对话式的。你提出问题，得到答案，但要把答案变成真正有用的东西——一份幻灯片、一篇文档、一张电子表格或一封邮件——仍然需要人工完成。

Claude Cowork 是 Anthropic 新推出的知识工作代理，它让你把这些工作委托给 Claude，从而把时间留给占用你时间的、更具战略性和创造性的问题。Claude Cowork 运行在 Claude 桌面应用中，可以读写本地文件，也能跨 Slack、Google Drive 等已连接应用工作，并把多步骤任务推进到真实交付物，同时引用实际文件和消息作为依据。你只需要描述目标、期望结果和节奏，Claude 就会列出步骤并完成工作，确保你始终参与其中、掌握每一步进展。
...
## 核心能力与工具选择 / Core capabilities and choosing the right tool

<!-- bilingual:section -->

<!-- lang:zh -->

为了帮助用户入门，Anthropic 整理了一份 Claude Cowork 实用产品指南，内容包括：

- Claude Cowork 与对话式 AI 工具的不同之处，以及它的核心能力，包括本地文件访问、subagents、长时间运行任务和定时任务。
- 一张产品矩阵，帮助理解什么时候该使用哪种工具：用 chat 做对话式起草，用 Claude Code 编写代码，用 Claude Cowork 处理跨应用的知识工作。
- 设置方式和系统要求、权限模型，以及首次上手时应该优先尝试的任务。
...
## 工作流、插件与指南 / Workflows, plugins, and the guide

<!-- bilingual:section -->

<!-- lang:zh -->

- 七类常见 Claude Cowork 工作流，包括研究简报、会议准备和周期性报告。
- 如何使用插件来完成营销、产品管理等特定知识工作。

可以在[这里](https://cdn.prod.website-files.com/6889473510b50328dbb70ae6/6a2313fa599bd2e2270fda75_Claude-eBook-Claude-Cowork-product-guide-06052026.pdf)查看这份指南。
