# Millennium 与 Anthropic 正在用 Claude 打造数字风险分析师 / Millennium and Anthropic are building a digital risk analyst with Claude
- 原始链接：https://claude.com/blog/millennium-and-anthropic-are-building-a-digital-risk-analyst-with-claude
- 来源：Claude Blog
- 作者：未提供
- 发布时间：2026-08-06
- 抓取时间：2026-08-06
...
Anthropic 正在与 Millennium 合作——这家公司是全球规模最大的另类投资管理公司之一——共同开发一款数字风险分析师：一名 AI 队友，在公司风险经理的监督下与其并肩工作，帮助发现新的风险洞察，并对跨资产类别的风险敞口形成判断。

如今，Claude 和 [Claude Code](https://claude.com/product/claude-code) 已被 Millennium 广泛应用，从交易台、工程团队到核心业务部门，覆盖多个领域。Millennium 的数字风险分析师进一步拓展了 Claude 的应用，帮助风险经理更快、更深入地分析风险头寸。
...
## 用 Claude 评估金融风险 / Evaluating financial risk with Claude

<!-- bilingual:section -->

<!-- lang:zh -->

投资公司花费了数十年时间利用技术改进风险度量，从传统评估逐步发展到更复杂的实时情景分析。Millennium 的数字风险分析师正是为处理这些关键工作流而设计，由 Millennium 的专有数据与 Claude 的前沿智能共同驱动。

数字风险分析师能够长期保留并调用信息，运用新的推理能力帮助解释每日风险变化。这些发现随后会由 Millennium 的人类风险经理进行验证和补充。
...
> 「在 Millennium，我们相信 AI 能够帮助员工树立新的成就标准，」Millennium 首席信息官 Vlad Torgovnik 表示。「我们与 Anthropic 的合作就是一个很好的例子，展示了 AI 如何在业务核心环节推动创新，同时让人类判断始终处于决策中心。我们很高兴能与行业领导者继续合作，探索 AI 为业务创造价值的新方式。」
...
## Millennium 员工如何使用 Claude / How Millennium employees use Claude

<!-- bilingual:section -->

<!-- lang:zh -->

Millennium 是 Claude 和 Claude Code 的早期采用者。员工使用 Claude Code 编写软件、构建产品并改进工作流，应用范围覆盖 Millennium 的 340 多个投资团队。

数字风险分析师通过记录推理过程、在沙盒环境中测试操作，并要求人类专家评估和批准其决策，提供安全、可审计的分析。Millennium 的风险专家正在与 Anthropic 的研究团队和应用 AI 团队共同构建这一工具；Anthropic 团队也在 Millennium 的 AI 实验室中与他们并肩工作。

Millennium 正在利用其内部 AI 实验室持续探索前沿，用雄心勃勃的用例对 Anthropic 最新的 Claude 模型进行压力测试，并让 Claude 在快节奏的环境中投入创新工作。
...
> 「金融服务需要的是在复杂、严苛环境中值得信赖的 AI，」Anthropic 金融服务董事总经理 Belinda Neal 表示。「Millennium 一直是 Claude 和 Claude Code 的早期采用者，我们与其风险团队的合作将展示 AI 如何为 Millennium 风险经理每天进行的分析提供支持。」

> 「Claude 能够对风险头寸进行推理、解释每日变化，并把学到的内容带入下一个问题，」Anthropic 资产与财富管理负责人 Peter Nolan 表示。「Millennium 的风险经理将利用前沿智能提供自动化建议，目标是节省宝贵时间。」

**了解更多：** 了解更多关于 [Claude 在金融服务领域的应用](https://claude.com/solutions/financial-services)，或[联系我们的团队](https://claude.com/contact-sales)，讨论 Claude 能在你的公司内部发挥哪些作用。
...
**Learn more:** Learn more about [Claude for financial services](https://claude.com/solutions/financial-services), or [contact our team](https://claude.com/contact-sales) to talk about what Claude can do inside your firm.
