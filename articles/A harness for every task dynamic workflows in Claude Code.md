...
That said, best practices are still developing! Dynamic workflows often use more tokens, so think carefully about when and how to use them. **Note**: this post is also [available on the Claude Blog](https://claude.com/blog/a-harness-for-every-task-dynamic-workflows-in-claude-code)
...
Thariq Shihipar and Sid Bidasaria ([@sidbid](https://x.com/@sidbid)) are members of technical staff at Anthropic, working on Claude Code.
