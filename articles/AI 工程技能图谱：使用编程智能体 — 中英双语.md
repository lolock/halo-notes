...
## 编程智能体为何是关键 AI 工程能力 / A key AI engineering skill in practice
...
## 一套可复用的软件构建工作流 / A reusable workflow for building software
...
## 工作流节奏差异与迭代回路 / Step duration and iterative loops in practice
...
**有效使用的关键能力 / Key skills for effective use**
...
## 编程智能体基础 / Foundations of coding agents
...
## 复杂迭代胜于盲目长跑 / Beyond long-horizon hype
